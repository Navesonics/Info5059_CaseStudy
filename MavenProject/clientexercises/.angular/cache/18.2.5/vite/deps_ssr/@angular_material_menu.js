...
var MatMenuItem = class _MatMenuItem {
  constructor(_elementRef, _document, _focusMonitor, _parentMenu, _changeDetectorRef) {
    ...
    this._hovered = new import_rxjs3.Subject();
    this._focused = new import_rxjs3.Subject();
...
var MatMenuContent = class _MatMenuContent {
  constructor(_template, _componentFactoryResolver, _appRef, _injector, _viewContainerRef, _document, _changeDetectorRef) {
    ...
    this._document = _document;
    this._changeDetectorRef = _changeDetectorRef;
    this._attached = new import_rxjs3.Subject();
  }
  /**
...
var MatMenuTrigger = class _MatMenuTrigger {
  ...
  constructor(_overlay, _element, _viewContainerRef, scrollStrategy, parentMenu, _menuItemInstance, _dir, _focusMonitor, _ngZone) {
    ...
    this._closingActionsSubscription = import_rxjs3.Subscription.EMPTY;
    this._hoverSubscription = import_rxjs3.Subscription.EMPTY;
    this._menuCloseSubscription = import_rxjs3.Subscription.EMPTY;
  ...
  _menuClosingActions() {
    ...
    const hover = this._parentMaterialMenu ? this._parentMaterialMenu._hovered().pipe((0, import_operators3.filter)((active) => active !== this._menuItemInstance), (0, import_operators3.filter)(() => this._menuOpen)) : (0, import_rxjs3.of)();
  ...
  _handleHover() {
    ...
    this._hoverSubscription = this._parentMaterialMenu._hovered().pipe((0, import_operators3.filter)((active) => active === this._menuItemInstance && !active.disabled), (0, import_operators3.delay)(0, import_rxjs3.asapScheduler)).subscribe(() => {
      this._openedBy = "mouse";
      if (this.menu instanceof MatMenu && this.menu._isAnimating) {
        this.menu._animationDone.pipe((0, import_operators3.take)(1), (0, import_operators3.delay)(0, import_rxjs3.asapScheduler), (0, import_operators3.takeUntil)(this._parentMaterialMenu._hovered())).subscribe(() => this.openMenu());
      } else {
        this.openMenu();
      }
    });
